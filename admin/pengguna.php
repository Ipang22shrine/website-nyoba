		...
		<div class="container">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<a href="tambah_pengguna.php"><i class="fa fa-plus"></i>Tambah</a>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="hapus-pengguna.php?idpengguna=<?= $p['id'] ?>" onclick="return confirm('Yakin ingin Hapus')" title="Edit Data" class="text-orange"><i class="fa fa-times"></i></a>
								</td>
							</tr>
